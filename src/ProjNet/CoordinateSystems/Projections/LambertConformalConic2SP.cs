...
namespace ProjNet.CoordinateSystems.Projections
{
    ...
    internal class LambertConformalConic2SP : MapProjection
	{
			...
			: base(parameters, inverse)
		{
			...
			double lat1 = DegreesToRadians(_Parameters.GetParameterValue("standard_parallel_1", ["latitude_of_origin"]));
			double lat2 = DegreesToRadians(_Parameters.GetParameterValue("standard_parallel_2", ["latitude_of_origin"]));
